...
**Time beiko:** Thanks, and I have a quick question I know. I think bonsai trees is like the default storage mode now if if that's right but I assume that non bonds I storage still is supported in basically is that is that.

**Justin Florentine:** Correct Yes it for us to still support it is actually still the default bonds.

**Time beiko:** forces the default.
...
**Time beiko:** Nice. Anyone have questions comments on that.
...
**Time beiko:**But if you actually.
