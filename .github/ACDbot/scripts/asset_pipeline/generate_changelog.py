...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog='Example: uv run --project .github/ACDbot .github/ACDbot/scripts/asset_pipeline/generate_changelog.py --call acde --number 226'
    )
    ...
    if args.call and args.number:
        print(f"Review the file, then run: uv run --project .github/ACDbot .github/ACDbot/scripts/asset_pipeline/apply_changelog.py -c {args.call} -n {args.number}")
    else:
        print("Review the file, then run: uv run --project .github/ACDbot .github/ACDbot/scripts/asset_pipeline/apply_changelog.py")
