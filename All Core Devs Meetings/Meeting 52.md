...
[ ] Go client fails on the 90 tests out of all of our test pool looks to b econfiguration errors or maybe high script errors?  [ ] Parity still being integrated into the hive. 
